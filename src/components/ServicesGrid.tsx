...
const services: Service[] = [
  {
    ...
    price: "From ₱31.50/lb",
    items: [
      { name: "Denim Jacket", price: "₱36.50", image: jacketImg },
      { name: "T-Shirt", price: "₱32.50", image: tshirtImg },
      { name: "Jeans", price: "₱35.00", image: jeansImg },
      { name: "Dress Shirt", price: "₱34.50", image: dressShirtImg },
      { name: "Polo Shirt", price: "₱33.50", image: poloImg },
      { name: "Hoodie", price: "₱37.00", image: hoodieImg },
      { name: "Sweater", price: "₱35.50", image: sweaterImg },
      { name: "Pants", price: "₱34.50", image: pantsImg },
      { name: "Shorts", price: "₱33.00", image: shortsImg },
      { name: "Skirt", price: "₱34.00", image: skirtImg },
    ],
  },
  {
    id: 2,
    ...
    price: "From ₱55/item",
    items: [
      { name: "Twin Comforter", price: "₱55.00", image: twinComforterImg },
      { name: "Queen Comforter", price: "₱65.00", image: queenComforterImg },
      { name: "King Comforter", price: "₱75.00", image: kingComforterImg },
      { name: "Duvet Cover", price: "₱60.00", image: duvetImg },
      { name: "Blanket", price: "₱50.00", image: blanketImg },
      { name: "Quilt", price: "₱58.00", image: quiltImg },
      { name: "Bedspread", price: "₱62.00", image: bedspreadImg },
      { name: "Throw Blanket", price: "₱45.00", image: throwImg },
      { name: "Sleeping Bag", price: "₱55.00", image: sleepingBagImg },
      { name: "Pillow", price: "₱42.00", image: pillowImg },
    ],
  },
  {
    id: 3,
    ...
    price: "From ₱38/item",
    items: [
      { name: "Suit Jacket", price: "₱42.00", image: suitJacketImg },
      { name: "Dress Pants", price: "₱38.00", image: dressPantsImg },
      { name: "Dress", price: "₱45.00", image: dressImg },
      { name: "Formal Gown", price: "₱55.00", image: gownImg },
      { name: "Blazer", price: "₱41.00", image: blazerImg },
      { name: "Winter Coat", price: "₱48.00", image: coatImg },
      { name: "Trench Coat", price: "₱46.00", image: trenchCoatImg },
      { name: "Silk Blouse", price: "₱40.00", image: silkBlouseImg },
      { name: "Wool Sweater", price: "₱39.00", image: woolSweaterImg },
      { name: "Necktie", price: "₱36.00", image: tieImg },
    ],
  },
  {
    id: 4,
    ...
    items: [
      { name: "Denim Jacket", price: "₱40.00", image: jacketImg },
      { name: "T-Shirt", price: "₱34.50", image: tshirtImg },
      { name: "Jeans", price: "₱38.00", image: jeansImg },
      { name: "Dress Shirt", price: "₱37.00", image: dressShirtImg },
      { name: "Polo Shirt", price: "₱35.50", image: poloImg },
      { name: "Hoodie", price: "₱41.00", image: hoodieImg },
      { name: "Sweater", price: "₱38.50", image: sweaterImg },
      { name: "Pants", price: "₱37.00", image: pantsImg },
      { name: "Shorts", price: "₱35.00", image: shortsImg },
      { name: "Skirt", price: "₱36.50", image: skirtImg },
    ],
  },
];
